...
window.onload = function()
{
	...
	*/
	...
	mundosWumpus = [{
		"dimensiones"	:	10,
		"posAvismos"	:	[[1,2],[2,1],[1,0],[3,4],[4,6],[6,7],[8,4],[7,2],[6,1],[4,0],[4,2],[1,6],[3,8],[7,8],[9,9],[0,8],[8,1],[9,0],[6,4],[8,6],[0,5],[1,8],[7,5],[9,3],[9,6]],
		"posWumpus"		:	[[2,3]],
		"posOro"		:	[[1,1]],
		"posAventurero"	:	[4,4]
	}];
	*/
	...
	function percePersonaje()
	{
		...
		var txtPercibe = "No hay peligro en la cercanías"; //El texto de las percenpciones....
		...
		*/
		...
		if(muere == 0)
		{
			...
			if(caeWumpusMuerto)
			{
				...
				console.log("Valor numWumpus es: " + numWumpus);
				audios("sounds/wumpus muerto.mp3");
		...
		else
		{
			...
			if(muere == 1)//Avismo..
			{
				audios("sounds/wumpus en abismo.mp3");
			}
			else
			{
				audios("sounds/wumpus en abismo.mp3");				
	...
	{
		var txtPercibe = "No hay flechas disponibles :(";
		var muere = false;
		if(numFlechas != 0)
		{
			...
			{
				txtPercibe = "El wumpus no ha muerto...";	
			}
			numFlechas--;
			nom_div("numflecha").innerHTML = numFlechas + " Disponible(s)";
		}
